      ...
      <section className="pt-32 pb-16 px-6 bg-gradient-to-b from-[#0b0b12] via-[#0b0b12] to-[#0b0b12]">
        <div className="max-w-6xl mx-auto text-center">
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className="w-6 h-6 rounded-full bg-gradient-to-r from-cyan-400 to-teal-400 flex items-center justify-center">
            ...
            <div className="mt-12 bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm animate-fade-in">
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-cyan-500 to-indigo-500 flex items-center justify-center text-white text-xs font-bold flex-shrink-0">
                    AI
                  </div>
                ...
                <div className="flex gap-3 justify-end">
                  <div className="bg-gradient-to-r from-cyan-600 to-indigo-600 rounded-2xl rounded-tr-none px-4 py-3 text-sm text-white max-w-[80%]">
